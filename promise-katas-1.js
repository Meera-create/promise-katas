...
//async function returns a promise by default so you dont need to write a new promise
...
const returnTen = async () => {
  return 10;
  };
  //it does the resolve for us because we added async
